...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let isPrerelease;
        const customTagPrerelease = (0, semver_1.prerelease)(customTag);
        ...
        const latestPrereleaseTag = (0, utils_1.getLatestPrereleaseTag)(validTags, preReleaseIdentifier, prefixRegex);
        let commits;
        let newVersion;
        if (customTag && !(0, semver_1.valid)(customTag)) {
            ...
            let releaseType;
            if (customTag) {
                releaseType = (0, semver_1.diff)(previousVersion, customTag);
            }
            else {
            ...
            if (!customTag) {
                const incrementedVersion = (0, semver_1.inc)(previousVersion, releaseType, preReleaseIdentifier);
        ...
        if (!isReleaseBranch) {
            core.info('This branch is not a release branch. Skipping the tag creation.');
            return;
        }
